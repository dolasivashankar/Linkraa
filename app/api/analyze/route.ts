      ...
      try {
        ...
        if (type === 'video') {
          formats.push({
            ...
            type: 'video',
            downloadUrl: `/api/proxy?url=${encodeURIComponent('https://www.w3schools.com/html/mov_bbb.mp4')}&name=${encodeURIComponent(baseName + '_1080p.mp4')}`,
          });
          formats.push({
            id: '720p',
            quality: '720p HD',
            ...
            type: 'video',
            downloadUrl: `/api/proxy?url=${encodeURIComponent('https://raw.githubusercontent.com/mdn/learning-area/master/html/multimedia-and-embedding/video-and-audio-content/rabbit320.mp4')}&name=${encodeURIComponent(baseName + '_720p.mp4')}`,
          });
          formats.push({
            id: '480p',
            ...
            type: 'video',
            downloadUrl: `/api/proxy?url=${encodeURIComponent('https://www.w3schools.com/html/mov_bbb.mp4')}&name=${encodeURIComponent(baseName + '_480p.mp4')}`,
          });
          formats.push({
            id: 'mp3_320',
